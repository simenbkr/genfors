...
$alternatives = "CREATE TABLE `genfors`.`alternatives` ( `id` INT NOT NULL AUTO_INCREMENT , `name` VARCHAR(100) NOT NULL , `votes` INT NOT NULL DEFAULT '0' , `election_id` INT NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;";
